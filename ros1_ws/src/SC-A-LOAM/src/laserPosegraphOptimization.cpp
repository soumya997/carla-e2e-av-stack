...
int main(int argc, char **argv)
{
    ...
    // save directories 
	nh.param<std::string>("save_directory", save_directory, "/home/opencvuniv/Work/somusan/robotics/nice_e2e_carla_av/trash/catkin_scaloam_ws/data/"); // pose assignment every k m move 
	...
	ros::Subscriber subLaserCloudFullRes = nh.subscribe<sensor_msgs::PointCloud2>("/carla/ego_vehicle/lidar", 100, laserCloudFullResHandler);
